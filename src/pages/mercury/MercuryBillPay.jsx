      ...
      <main className="mercury-dashboard-main">
        ...
        <div className="mercury-dashboard-content">
          <div className="mercury-page-header">
            <h1 className="mercury-page-title">Bill Pay</h1>
            <button type="button" className="mercury-btn-primary mercury-btn-inline">↑ Upload Bill</button>
          </div>
          ...
          <div className="mercury-billpay-empty">
            <p>Your inbox is empty. Drag and drop bills or forward them to mobbin@ap.mercury.com</p>
            <button type="button" className="mercury-btn-primary mercury-btn-inline">Upload Bill</button>
          </div>
        </div>
      </main>
