    ...
    <div className="mercury-flow-layout">
      <div className="mercury-step">
        ...
        <div style={{ display: 'flex', gap: 12, marginBottom: 24 }}>
          <button type="button" className="mercury-btn-secondary mercury-btn-inline" style={{ flex: 1 }}>Copy</button>
          <button type="button" className="mercury-btn-secondary mercury-btn-inline" style={{ flex: 1 }}>Print</button>
          <button type="button" className="mercury-btn-secondary mercury-btn-inline" style={{ flex: 1 }}>Download</button>
        </div>
