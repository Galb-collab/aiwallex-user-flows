  ...
  return (
    <div className="wallet-content">
      ...
      <div className="scheduling-transfer-options conversions-options">
        <Link to={flowPath('/flow/wallet/new-conversion')} className="scheduling-transfer-card conversions-card">
        ...
        <Link to={flowPath('/flow/wallet/conversions/limit-order')} className="scheduling-transfer-card conversions-card">
          <span className="scheduling-transfer-card-icon">📋</span>
        ...
        <Link to={flowPath('/flow/wallet/conversions/rate-alert')} className="scheduling-transfer-card conversions-card">
          <span className="scheduling-transfer-card-icon">🔔</span>
