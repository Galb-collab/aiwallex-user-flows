...
const FLOWS = [
  ...
  { path: '/flow/wallet', icon: '👛', title: 'Wallet', description: 'Balances (total, cash table, Yield card), Global accounts (list + Create global account flow), Transactions, Linked Accounts, Settings; plus Cash balance details, Discover Airwallex Pay, Display currencies, New transfer, Creating conversion (with Give feedback).' },
