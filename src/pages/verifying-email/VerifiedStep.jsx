  ...
  return (
    <div className="vem-verified">
      <div className="vem-verified-content">
        ...
        <button type="button" className="vem-dashboard-btn" onClick={() => navigate('/flow/completing-business-details/submitting-application')}>
          Back to application
        </button>
        <button type="button" className="vem-dashboard-btn btn-outline" onClick={() => navigate('/flow/web-onboarding/dashboard')} style={{ marginTop: 8 }}>
