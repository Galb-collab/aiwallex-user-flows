        ...
        <nav className="sidebar-nav">
          ...
          <div className="sidebar-nav-item active-wrap">
            ...
            <div className="sidebar-sub">
              <Link to="/flow/settings" className={isIndex ? 'active' : ''}>Overview</Link>
              <Link to="/flow/settings/connections" className={isConnections ? 'active' : ''}>Connections</Link>
              <Link to="/flow/settings/creating-a-user" className={isCreatingUser && !isAddingCustomRole && !isCancellingInvitation && !isCreatingDepartment && !isCreatingLocation && !isRemovingEmploymentType && !isRoleDetails ? 'active' : ''}>Creating a user</Link>
              <Link to="/flow/settings/creating-a-user/adding-a-custom-role" className={isAddingCustomRole ? 'active' : ''}>Adding a custom role</Link>
              <Link to="/flow/settings/creating-a-user/cancelling-an-invitation" className={isCancellingInvitation ? 'active' : ''}>Cancelling an invitation</Link>
              <Link to="/flow/settings/creating-a-user/creating-a-department" className={isCreatingDepartment ? 'active' : ''}>Creating a department</Link>
              <Link to="/flow/settings/creating-a-user/creating-a-location" className={isCreatingLocation ? 'active' : ''}>Creating a location</Link>
              <Link to="/flow/settings/creating-a-user/removing-employment-type" className={isRemovingEmploymentType ? 'active' : ''}>Removing employment type</Link>
              <Link to="/flow/settings/creating-a-user/role-details/admin" className={isRoleDetails ? 'active' : ''}>Role details</Link>
              <Link to="/flow/settings/developer" className={isDeveloper && !isCreatingApiKey ? 'active' : ''}>Developer</Link>
              <Link to="/flow/settings/developer/creating-an-api-key" className={isCreatingApiKey ? 'active' : ''}>Creating an API key</Link>
              <Link to="/flow/settings/plan-billing" className={isPlanBilling ? 'active' : ''}>Plan & billing</Link>
              <Link to="/flow/settings/updating-card-expenses-approvals" className={isCardExpensesApprovals ? 'active' : ''}>Updating card expenses approvals</Link>
            </div>
          </div>
        </nav>
