...
export function RequestsFlow() {
  ...
  return (
    <div className="dashboard spend-general requests-flow">
        ...
        <nav className="sidebar-nav">
          ...
          <div className="sidebar-nav-item active-wrap">
            ...
            <div className="sidebar-sub">
              ...
              <Link to={flowPath('/flow/requests')} className="active">Requests</Link>
            </div>
          </div>
      ...
      <div className="dashboard-main">
        <DashboardHeader email={EMAIL} className="bills-header">
          <nav className="bills-tabs">
            ...
            <NavLink to={flowPath('/flow/requests')} end className={({ isActive }) => `bills-tab${isActive ? ' active' : ''}`}>Summary</NavLink>
